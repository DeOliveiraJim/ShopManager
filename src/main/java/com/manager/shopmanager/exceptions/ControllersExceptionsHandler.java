...
public class ControllersExceptionsHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(ElementNotFoundException ex,HttpStatus status, WebRequest request)  {
        return sendResponseEntity(createErrorResponse(ex,"Requested element not found.",status,request));
    }
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        message.append("  -> this http method is not supported." +
    ...
    protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        message.append("  -> this media type is not supported. " +
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ErrorMessage err = createErrorResponse(ex,"Problem in JSON request, check 'errors' for more information",status, request);
